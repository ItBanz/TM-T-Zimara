...
const cardData = [
    {
        ...
        image: 'https://down-vn.img.susercontent.com/file/vn-11134201-23030-ndvni3cnm6nvc7_tn',
    },
    {
        id: 2,
        title: '370.000 VNĐ',
        ...
        <>
            <div className="Deal-container">
                <div className="title-deal">
                    <div className="title-deal-container">
                        <div className="">
                            <h4>Flash Sale</h4>
                        </div>
                        <div>
                ...
                <div className="slide-card-container">
                    <Slider {...sliderSettings}>
                        {cardData.map((card) => (
                            <div key={card.id} className="slide-card">
