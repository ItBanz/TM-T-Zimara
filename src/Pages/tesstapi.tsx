                        ...
                        <ul class="row list-unstyled align-items-center pt-4 pb-4">
                            ...
                            <div class="col">
                                <ul class="row list-unstyled heading-title-item">
                                    ...
                                    <li class="col text-center">Số Lượng</li>/-strong/-heart:>:o:-((:-h<li class="col text-center">Số Tiền</li>
                                                        ...
                                                        <li class="col">
                                                            <div class="z_checkbox px-3">
                                                                <input
                                                                    ...
                                                                    type="checkbox"
                                                                    id="buy_this_product"
                                                                    name="check_buy_all"/-strong/-heart:>:o:-((:-hvalue="buy_all"
                    ...
                    <div class="bg-white py-3 px-4 rounded shadow-sm">
                        ...
                        <div class="row">
                            <div class="col-md-6 d-flex align-items-center">
                                <div class="z_checkbox px-3">/-strong/-heart:>:o:-((:-h<input class="check-input" type="checkbox" id="buy_all" name="check_buy_all" value="buy_all"
                                                                    onChange={() => {
